...
function parDeBarreiras(altura, abertura, x){
    ...
    this.sotearAbertura = () => {
        ...
        const alturaInferior = altura - abertura - alturaSuperio;
...
function passaro(alturaJogo){
    ...
    this.animar = () => {
        ...
        if(novoY <= 0){
            this.setY(0);
        }else if (novoElemento >= alturaMaxima) {
...
// this.areaDoJogo.appendChild(new progresso().elemento);
// barreiras.pares.forEach(par => areaDoJogo.appendChild(par.elemento));
